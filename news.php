...
<div class="menutable_bottom">.</div>	
			...
			<td height="30" width="743" valign="top" style="TEXT-ALIGN: left;padding-left:10px" >
...
<br><a href="javascript:history.back(1)">回上一頁 </a><br><br>
	...
	<div style="z-index:10;margin:-15px 0px 0px 0px; background-image : url(images/linedown.jpg);color: #fff;">.</div>
