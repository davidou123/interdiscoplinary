...
$error="<b><font size='2' color='#FF0000'>OOPS您輸入錯誤溜</font></b>";//登入失敗
  ...
  mysql_free_result($result);
	...
	$link = create_connection();
	// 建立SQL指令字串
	$sql = "SELECT * FROM  inter  where name='business_service' ";
	$result = mysql_query($sql); // 執行SQL指令
	if (mysql_num_rows($result) != 0) 
	{
  while ($rows = mysql_fetch_array($result, MYSQL_BOTH)) 
...
<div class="menutable_bottom">.</div>	
	...
	<tr>
		<td width="160" valign="top" background="images/dot.png"  style="border-right-color : #DCDCDC;border-right-width: 1px; border-right-style: solid;"><img border="0" src="images/business.png" width="138" height="158" style="padding-left:10px"></td>
		<td style="padding:10px">
		<img border="0" src="images/business_service.png" width="532" height="33" alt="商業服務實習學程">
